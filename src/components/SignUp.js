  ...
  render() {
    ...
    return (
      <div id="main-registration-container">
        <div id="register">
          <h3 style={{ fontWeight: "bold" }}>Registration page</h3>
          <form
            method="post"
          ...
          >
            ...
            <label style={{ fontSize: "25px" }}>Email Address:
              <br />
            ...
            <label style={{ fontSize: "25px" }}>Mobile :
              <br />
              <span style={{ fontSize: "20px" }} >
            ...
            <label style={{ fontSize: "25px" }}>Password
              <br />
              <span style={{ fontSize: "20px" }} >
